...
YUGAC=./bin/yugac
APP_REL=packages/yuga/tests/bench/bench.yuga
...
BASE_APP_REL=packages/yuga/tests/bench/bench.yuga
for cand in packages/yuga/tests/bench/bench.yuga yuga/tests/bench/bench.yuga; do
